...
Uma landing page para adicionar links de redes sociais e outros, projeto inspirado no Link tree
...
Você pode visualizar o deploy do projeto na vercel através [desse link](https://link-pointer-mat.vercel.app/).
...
```bash
git clone https://github.com/MatheusRamalho/link-pointer
```
